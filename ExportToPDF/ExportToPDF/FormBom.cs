...
namespace ExportToPDF
{
    ...
    public partial class FormBom : Form
    {
        ...
        private void OnControlLoaded(EModelViewControl ctrl)
        {
            ...
            m_Mtrl = m_Ctrl.CoCreateInstance("EModelViewMarkup.EmodelMarkupControl") as EModelMarkupControl;
        ...
        private void OnDocumentLoaded(string fileName)
        {
            ...
            m_Mtrl.ViewOperator = EMVMarkupOperators.eMVOperatorStamp;


            try
            {
              m_Mtrl.AddStamp("D://approved.png", 0, 0, 0, 0);
            }
            catch (Exception e)
            {
        ...
        private void PrintNext()
        {
            ...
            if (listDrawing.Count > 0)
            {
              ...
              //  string  pdfFilePath = Path.Combine(outDir, pdfFileName);
              //  AddTextStampPage.Run(pdfFilePath, 1);
